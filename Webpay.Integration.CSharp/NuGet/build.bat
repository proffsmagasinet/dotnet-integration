...
"%MSBUILD_PATH%" "%SOURCE_DIR%\Webpay.Integration.CSharp.sln" /nologo /verbosity:m /t:Build /p:Configuration=Release;Platform="Any CPU"

nuget pack "%SOURCE_DIR%\Webpay.Integration.CSharp\Webpay.Integration.CSharp.csproj" -IncludeReferencedProjects -Symbols -Properties Configuration=Release -o "%TARGET_DIR%"
